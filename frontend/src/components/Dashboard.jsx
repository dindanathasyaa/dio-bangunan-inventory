                        ...
                        {filteredInventory.map(item => {
                            ...
                            return (
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        <button className="btn-icon" style={{color: 'white', fontWeight: 'normal', fontSize: '0.8rem', padding: '4px 12px', background: 'linear-gradient(145deg, #ed5509, #c2410c)', borderRadius: '6px', boxShadow: '2px 4px 8px rgba(0,0,0,0.2), inset 1px 1px 2px rgba(255,255,255,0.3)', textShadow: '0 1px 1px rgba(0,0,0,0.1)'}} onClick={() => setEditingData({...item})} title="Edit Data">
                                            Edit
                                        </button>
                                    </td>
                                </tr>

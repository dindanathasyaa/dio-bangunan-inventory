    ...
    return (
        <div style={{animation: 'fadeIn 0.5s ease-out', paddingBottom: '40px'}}>
            <div style={{display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '24px'}}>
                <h1 style={{margin: 0, alignSelf: 'flex-start', background: 'var(--primary-color)', color: 'white', WebkitTextFillColor: 'white', WebkitBackgroundClip: 'initial', padding: '8px 16px', borderRadius: '8px', fontSize: '1.4rem', boxShadow: '0 4px 6px rgba(237, 85, 9, 0.2)'}}>Control Center</h1>

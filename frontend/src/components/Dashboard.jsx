        ...
        <div className="app-container">
            <aside className={`sidebar ${!isSidebarOpen ? 'collapsed' : ''}`}>
                ...
                <div className="logo-container" style={{paddingBottom: '0', display: 'flex', justifyContent: 'center', marginTop: '40px', marginBottom: '0'}}>
                    <img src="/logo-transparent.png" alt="Dio Bangunan Logo" className="logo-img" style={{width: '80%', display: 'block'}} />
                </div>
                
                <nav onClick={(e) => { if (window.innerWidth <= 768 && e.target.closest('a')) setIsSidebarOpen(false); }} style={{display: 'flex', flexDirection: 'column', marginTop: '4px', flex: 1, overflowY: 'auto', overflowX: 'hidden'}}>
    ...
    return (
        <div style={{animation: 'fadeIn 0.5s ease-out', paddingBottom: '40px'}}>
            ...
            <div className="summary-grid" style={{marginBottom: '24px'}}>
                ...
                {user.role === 'OWNER' && (
                    <div className="glass-panel" style={{borderTop: '4px solid var(--primary-color)', cursor: 'pointer', transition: 'transform 0.2s', width: '100%', flex: '1 1 100%', background: 'linear-gradient(to right, rgba(234, 88, 12, 0.1), transparent)'}} onClick={() => navigate('/cash', { state: { view: 'CashFlow' } })}>
                        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                            <div>
